...
builder.Services.AddAuthentication(options => { 
    ...
    .AddJwtBearer(options =>
    {
        ...
        options.TokenValidationParameters = new Microsoft.IdentityModel.Tokens.TokenValidationParameters()
        {
            ...
            ClockSkew = TimeSpan.Zero // Para evitar tiempos de gracia despuÈs de la expiraciÛn
        };
    });
...
//opcion para agregar al Swagger y se ponga el token de seguridad
...
app.UseCors(options =>
{
    options.AllowAnyHeader(); // Permitir cualquier encabezado de configuraci√≥
