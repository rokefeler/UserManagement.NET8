...
const Button = ({
  ...
  const primaryClasses =
    " text-white bg-btn btn-[#754eb4] border-[#754eb4] hover:shadow-[0_0_5px_5px_#754eb44c]";
  const secundaryClasses =
  ...
  const classNameCreator = (): string => {
    ...
    if (variant === "primary") finalClassName += primaryClasses;
    else if (variant === "secondary") finalClassName += secundaryClasses;
    else if (variant === "danger") finalClassName += dangerClasses;
    else if (variant === "light") finalClassName += lightClasses;
    finalClassName +=
