...
//URLS
export const HOST_API_KEY = "http://localhost:5197/api";
...
export const PATH_AFTER_UNAUTHORIZED = PATH_PUBLIC.unauthorized;
export const PATH_AFTER_FORBIDDEN = PATH_PUBLIC.unauthorized;
